# FIBMO
`FIBMO` is the FITS Interactive Browser for Multi-wavelength Observations, an in-development, light-weight Python alternative designed for exploring multi-wavelength data simultaneously.
